...
BOOST_LOG_GLOBAL_LOGGER_INIT(my_logger, logger_t)
{
    ...
    logging::add_file_log(
        ...
        keywords::target_file_name = "../log/saved/image_taking_%Y-%m-%d_%H-%M-%S.%N.log", //filename after the program decides to save the log completely. Usually after the program closes or file size or time based settings set.
        keywords::auto_flush = true,                                                                //writes messages immediately to file. Should be used only for debug.
        keywords::format = "[%TimeStamp%] [%ThreadID%] [%Severity%] %Message%",
        keywords::time_based_rotation = sinks::file::rotation_at_time_point(7, 30, 0), // hour, minute, second
        keywords::open_mode = std::ios_base::out | std::ios_base::app,                 //Apends data to the log instead of overwriting.
    ...
    logging::add_file_log(
        ...
        keywords::target_file_name = "../log/saved/target_env_%Y-%m-%d_%H-%M-%S.%N.log", //filename after the program decides to save the log completely. Usually after the program closes or file size or time based settings set.
        keywords::auto_flush = true,                                                                    //writes messages immediately to file. Should be used only for debug.
        //keywords::format = "[%TimeStamp%] [%ThreadID%] [%Severity%] %Message%",
    ...
    logging::add_file_log(
        ...
        keywords::target_file_name = "../log/saved/target_data_%Y-%m-%d_%H-%M-%S.%N.log", //filename after the program decides to save the log completely. Usually after the program closes or file size or time based settings set.
        keywords::auto_flush = true,                                                                     //writes messages immediately to file. Should be used only for debug.
        //keywords::format = "[%TimeStamp%] [%ThreadID%] [%Severity%] %Message%",
        keywords::format = "%TimeStamp% %Message%",
        keywords::time_based_rotation = sinks::file::rotation_at_time_point(7, 30, 0), // hour, minute, second
    ...
    logging::add_file_log(
        ...
        keywords::target_file_name = "../log/saved/target_settings_%Y-%m-%d_%H-%M-%S.%N.log", //filename after the program decides to save the log completely. Usually after the program closes or file size or time based settings set.
        keywords::auto_flush = true,                                                                    //writes messages immediately to file. Should be used only for debug.
        //keywords::format = "[%TimeStamp%] [%ThreadID%] [%Severity%] %Message%",
        keywords::format = "%TimeStamp% %Message%",
        keywords::time_based_rotation = sinks::file::rotation_at_time_point(7, 30, 0), // hour, minute, second
